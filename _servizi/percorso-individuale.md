---
card_title: Percorso individuale
order: 30
icon: user
...
- Difficoltà che si ripetono senza una causa chiara
- Desiderio di conoscersi meglio e capire i propri schemi
- Periodi di stanchezza, demotivazione o confusione
faq:
- q: Quanto dura una seduta?
  a: Le sedute individuali durano circa 50 minuti, con cadenza generalmente settimanale.
- q: Posso iniziare anche se non so bene cosa mi porta qui?
  a: 'Sì. Molte persone iniziano proprio con l''idea poco chiara: il primo colloquio serve anche a mettere a fuoco
    insieme di cosa hai bisogno.'
---

La psicoterapia individuale è un percorso pensato per chi sente il bisogno di fermarsi e guardare con più chiarezza a un momento della propria vita: un cambiamento importante, una difficoltà che si trascina da tempo, oppure semplicemente il desiderio di conoscersi meglio.
